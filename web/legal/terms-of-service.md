...
the Service may be incomplete, may change significantly, and may occasionally be
unavailable.
...
licence exists only so the Service can work; it ends when you delete the content or
your account, except for copies our providers process transiently and any copies we
must keep to comply with law.
...
- upload content that is illegal, infringing, hateful, harassing, or that depicts
  another person without the consent you need — and never sexual content involving
  minors;
- upload other people's private or confidential information without permission;
- attempt to reverse‑engineer, scrape, overload, disrupt, or gain unauthorised
  access to the Service or its AI systems, or use it to build a competing model or
  dataset;
- probe or bypass rate limits, security, or usage controls; or
- misrepresent your identity or affiliation.

We may suspend or remove content or access that we reasonably believe breaks these
Terms.
...
works from the Service except as these Terms allow.
...
uninterrupted, secure, error‑free, or that AI output will be accurate. Some
jurisdictions do not allow the exclusion of certain warranties, so some of these
...
- our total liability for all claims relating to the Service will not exceed the
  greater of the amount you paid us in the 12 months before the claim, or **US
  $100**.

Nothing in these Terms limits liability that cannot be limited under applicable law
(for example, for death or personal injury caused by negligence, or for fraud). If
you are a consumer, you may have rights that these Terms do not override.
...
updated" date and, for material changes, give reasonable notice (for example by
email or an in‑app notice). If you keep using the Service after an update takes
...
Nothing here removes mandatory consumer‑protection rights you have in your country
of residence.
